...
object DynamicInvoker {
    ...
    fun visitTypeInsn(list: InsnList, iter: InsnIterator, insn: TypeInsnNode) {
        ...
        when (insn.opcode) {
            ...
            // TODO INSTANCEOF (generate class with static class fields and call isInstance method)
    ...
    fun visitMultiANewArrayInsn(ist: InsnList, iter: InsnIterator, insn: MultiANewArrayInsnNode) {
        if (isPluginClass(insn.desc))
